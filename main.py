...
def main():
    ...
    parser.add_argument('-task', type=str, default='ensemble_naive_voting', choices=['statistics', 'rank', 'formatlatex', 'split_dataset', 'generate_quads', 'best_predictions', 'ensemble_naive_voting'])
