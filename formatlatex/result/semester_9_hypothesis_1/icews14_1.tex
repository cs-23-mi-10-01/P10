...
(1, 0.485840495935422) %DE_SimplE
(2, 0.40864722143311377) %ATISE
(3, 0.4998850216977859) %TERO
} ;
\addplot[color=ourdarkred, fill=ourlightred] coordinates { %relation
(0, 0.2050733839712357) %DE_TransE
(1, 0.29419180983873955) %DE_SimplE
(2, 0.2651920008232943) %ATISE
(3, 0.34365312580396906) %TERO
} ;
\addplot[color=ourdarkyellow, fill=ourlightyellow] coordinates { %tail
(0, 0.3277892854794874) %DE_TransE
(1, 0.5174294134375389) %DE_SimplE
(2, 0.4339695690436387) %ATISE
(3, 0.532289407508887) %TERO
} ;
\addplot[color=ourdarkgreen, fill=ourlightgreen] coordinates { %time_from
(0, 0.09517766038307589) %DE_TransE
(1, 0.0809454461243896) %DE_SimplE
(2, 0.09372231337334733) %ATISE
(3, 0.20829942435104987) %TERO
} ;
